            ...
            <form action="<c:url value='/marketBoard/update'/>" id="boardModify" method="POST" enctype="multipart/form-data">
                <table>
                    ...
                    <tr>
                        <td>작성자</td>
                        <td>
                        	<input type="text" name="memberNick" size=20 value="${detail.memberNick }" readonly> 
                        	<input type="hidden" name="memberNum" value="${detail.memberNum }">
                        </td>
                    </tr>

                    <tr>
                        <td>제목<sup> ( <span id="nowByte">최대 </span> / 200bytes )</td>
                        <td><input type=text id="mbTitle" name="mbTitle" size="60" value="${detail.mbTitle }"></td>
                    </tr>

                    <tr>
                        <td>내용<sup>( <span id="nowByte2">최대 </span> / 2000bytes )</td>
                        <td><textarea name="mbContent" id="mbContent" cols="75" rows="15">${detail.mbContent }</textarea></td>
                    </tr>
                    ...
                    <tr>
                        <td>사진올리기 </td>
                        <td><input multiple="multiple" type="file" id="uploadFiles" name="fileName" size="10" maxlength="10"></td>
                    </tr>
                    <tr>
                        <td>가격 </td>
