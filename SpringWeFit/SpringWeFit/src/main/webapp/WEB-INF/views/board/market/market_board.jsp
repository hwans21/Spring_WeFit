       ...
       <div class="row">
        ...
        <div class="container text-center"> 
         ...
         <div class="row gray-row">
            <button class="btn ${pc.paging.category == 'buy'? 'btn-primary':'btn-default' }" onclick="location.href='<c:url value="/marketBoard/market_board?category=buy" />'">삽니다</button>
               <button class="btn ${pc.paging.category == 'sell'? 'btn-primary':'btn-default' }" onclick="location.href='<c:url value="/marketBoard/market_board?category=sell" />'">팝니다</button>
               <button class="btn ${pc.paging.category == 'share'? 'btn-primary':'btn-default' }" onclick="location.href='<c:url value="/marketBoard/market_board?category=share" />'">나눠요</button>
               <button class="btn ${pc.paging.category == null? 'btn-primary':'btn-default' }" onclick="location.href='<c:url value="/marketBoard/market_board" />'">전체 보기</button><br/>
                        ...
                        <c:forEach var="vo" varStatus="i" items="${product}">                               
                                <c:if test="${i.count % 3 == 1}">
                                   <tr class="course"> 
                                       ...
                                       <td scope="col" class="text-center" style="width: 33%" onclick="location.href='<c:url value='/marketBoard/market_detail?mbNum=${vo.mbNum }&pageNum=${pc.paging.pageNum }&keyword=${pc.paging.keyword }&condition=${pc.paging.condition }&order=${pc.paging.order }&category=${pc.paging.category }	' />'">
                                           <div class="vid" >                               
